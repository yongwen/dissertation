...
\begin{table}[ht!]
  \centering
  \begin{tabular}{|p{0.12\columnwidth}|p{0.12\columnwidth}|p{0.12\columnwidth}|p{0.17\columnwidth}|p{0.12\columnwidth}|p{0.1\columnwidth}|}
    \hline
    \tabhead{Instances} &
    \tabhead{Duration} &
    \tabhead{Populations} &
...
\begin{table}[ht!]
  \centering
  \begin{tabular}{|p{0.17\columnwidth}|p{0.3\columnwidth}|p{0.44\columnwidth}|}
    \hline
    \tabhead{Stakeholder}&
    ...
    \multirow{2}{0.44\columnwidth}{Determine strengths and weaknesses in system install and maintenance}\\
    \cline{2-2}
    & In-lab system admin study & \\
    \hline
    \multirow{2}{*}{Game designer} & Post-hoc designer interview \& log data analysis &
	\multirow{2}{0.44\columnwidth}{Determine strengths and weaknesses in facilitating the game design process} \\
	\cline{2-2}	
	& In-lab game design study & \\
    \hline
    \multirow{2}{*}{Game manager} & Post-hoc manager interview \& log data analysis & 
	 \multirow{2}{0.44\columnwidth}{Determine strengths and weaknesses in managing the game} \\
	\cline{2-2} 
...
\begin{table}[ht!]
  ...
  \begin{tabular}{|p{0.2\columnwidth}|p{0.4\columnwidth}|p{0.2\columnwidth}|}
    ...
    \hline
    System admin &
    ICS691 students, system admin for HPU instance &
    UHM, HPU\\
    \hline
    Game designer &
    ICS691 students, game designer for HPU  \& EWC instance &
    UHM, HPU, EWC \\
    \hline
    Game manager &
    ICS691 students, game designer for HPU \& EWC instance &
