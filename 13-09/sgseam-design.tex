...
The assessment approaches is divided into in-vivo and in-vitro assessments. The in-vivo approaches, 
...
\begin{table}[ht!]
  \centering
  \begin{tabular}{|P{0.18\columnwidth}|P{0.4\columnwidth}|P{0.15\columnwidth}|P{0.15\columnwidth}|}
    \hline
    ...
    \hline
    \multirow{3}{0.18\columnwidth}{Step 2: Gather data} & 2a) Carry out assessments & responses from stakeholders & 
    \multirow{3}{0.15\columnwidth}{Data repository} \\    
    \cline{2-3}
     & 2b) Obtain log data & website/ game logs & \\
    \hline
