...
Figure \ref{fig:makahiki-landing} shows a sample landing page of Makahiki system.
...
The ``Drop Down'' page provides the user interface to the ``water'' games, as shown in Figure \ref{fig:makahiki-dropdown}:
...
System admins use the ``Site configuration'' button to configure the site related to the authentication, wattdepot server connectivity, and the email. \autoref{makahiki-sys-setting} shows the system admin interface.
...
The game settings define the configurations for each individual games and game mechanics in Makahiki. \autoref{makahiki-designer-setting} shows the challenge design interface.
...
\autoref{makahiki-manager-setting} shows the challenge management interface.
...
Developers use the ``Developers'' button to debug the system, configure new pages and games. \autoref{makahiki-developer-setting} shows the developer interface.
