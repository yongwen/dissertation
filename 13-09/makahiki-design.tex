...
The next section describes Makahiki as it is viewed by external users of the system.

\section{System Description}
\label{sec:makahiki-design-description}

This section describes Makahiki from the perspectives of different users. It first describes the installation process from the system administrator's view, followed by the descriptions of different system interfaces to players, system admins, game designers, game managers and developers.
